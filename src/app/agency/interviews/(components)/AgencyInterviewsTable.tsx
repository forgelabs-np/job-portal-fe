...
import { useGetAgencyInterviewsQuery, useGetAgencyInterviewByIdQuery } from "@/api/agency";
...
const AgencyInterviewsTable = () => {
  ...
  const { data: interviewDetail, isLoading: isLoadingDetail } = useGetAgencyInterviewByIdQuery(viewId);
...
export default AgencyInterviewsTable;
