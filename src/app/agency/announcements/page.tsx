  ...
  return (
    ...
    >
      ...
      <VStack align="start" gap={3}>
        <Badge colorPalette={getTypeColor(announcement.announcementType)} px={3} py={1} borderRadius="full" w="fit-content">
...
const AgencyAnnouncementsPage = () => {
  const { data: response, isLoading } = useAnnouncements({targetAudience: "AGENCY_ONLY"});
