...
const GOLD: [number, number, number] = [212 / 255, 175 / 255, 55 / 255];
const GOLD_BRIGHT: [number, number, number] = [244 / 255, 208 / 255, 108 / 255];

/** Preset tuned for dark landing sections (Chakra gold palette) */
// export const landingGlobeColors = {
//   markerColor: GOLD_BRIGHT,
//   arcColor: GOLD,
//   baseColor: [0.14, 0.14, 0.16] as [number, number, number],
//   glowColor: [0.35, 0.3, 0.22] as [number, number, number],
//   dark: 1,
//   mapBrightness: 8,
// } as const;

export const landingGlobeColors = {
  markerColor: GOLD_BRIGHT, // bright gold markers
  arcColor: GOLD, // white arcs
